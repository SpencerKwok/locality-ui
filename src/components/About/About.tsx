...
function About(props: AboutProps) {
  return (
    <Stack direction="row" columnAlign="center">
      <StyledStack direction="column" rowAlign="center" spacing={32}>
        <header>
          <h1>About Us</h1>
        </header>
        <main>
          <Stack direction="column" rowAlign="center" spacing={32}>
            ...
            >
              ...
              <p>
                ...
                built a platform that empowers them to thrive and succeed. We
                help our business communities connect with buyers looking for a
                more local, personal, and unique touch.
              </p>
            </DescriptionImage>
            <DescriptionImage
              alt="How it works"
            ...
            >
              ...
              <p>
                ...
                costs (all services are currently free) and minimal risks. Want
                to be a Locality lister? All it takes is one photo to get
                started.
              </p>
            </DescriptionImage>
            <DescriptionImage
            ...
            >
              ...
              <p>
                ...
                having to change their current search habits. Find out what
                causes you are helping to support in your own community or
                another’s with each purchase.
              </p>
            </DescriptionImage>
          </Stack>
        </main>
