...
import DescriptionImage from "../Image/DescriptionImage";
      ...
      >
        ...
        >
          ...
          <p>
            ...
            owned small businesses at the heart of commerce. That’s why we built
            a platform that empowers them to thrive and succeed. We help our
            business communities connect with buyers looking for a more local,
        ...
        >
          ...
          <p>
            ...
            beginning, the platform will empower you to do what you love and get
            your products in front of the right people. For buyers, we will help
            you find what you are looking for from a local source that leaves a
            positive social, environmental, or ethical impact.
          </p>
        </DescriptionImage>
        <DescriptionImage
          direction="row"
        ...
        >
          ...
          <p>
            ...
            Locality lister? All it takes is one (insert photo dimensions here)
        ...
        >
          ...
          <p>
            Our search tool helps buyers explore local offerings without having
            to change their current search habits. Find out what causes you are
            helping to support in your own community or another’s with each
            purchase.
          </p>
        </DescriptionImage>
      </Stack>
