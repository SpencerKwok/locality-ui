...
describe("User signup", () => {
  ...
  it("Invalid subscribe (string), invalid inputs, logged once + client error response", async () => {
    // Arrange
    const firstName = faker.name.firstName();
    const lastName = faker.name.lastName();
    const email = faker.internet.email();
    ...
    const mockReq = httpMocks.createRequest({
      ...
      body: {
        ...
        password1: password,
        password2: password,
        subscribe: faker.datatype.string(),
      },
    });
    const mockRes = httpMocks.createResponse();
  ...
  it("Missing subscribe, invalid inputs, logged once + client error response", async () => {
    // Arrange
    const firstName = faker.name.firstName();
    const lastName = faker.name.lastName();
    const email = faker.internet.email();
