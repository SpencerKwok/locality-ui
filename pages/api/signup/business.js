...
export default async function handler(req, res) {
  ...
  try {
    ...
    const [, psqlErrorAddBusiness] = await Psql.query(
      SqlString.format(
        "INSERT INTO businesses (id, name, address, city, province, country, latitude, longitude, next_product_id, logo, homepage, shopify_homepage, etsy_homepage, departments) VALUES (?, E?, E?, E?, E?, E?, ?, ?, ?, E?, E?, E?, E?, E?)",
        [
          userId,
          businessName,
          address,
